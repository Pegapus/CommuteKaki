...
| `GET` | `/api/routing/plan?start=&end=&date=&time=&preference=&maxCrowd=&maxTransfers=&maxWalk=&includeUnknown=` | Returns deduplicated and ranked OneMap point-to-point alternatives, enriched with LTA rail crowd readings |
